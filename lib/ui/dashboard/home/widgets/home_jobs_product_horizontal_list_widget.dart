...
class HomeJobsProductHorizontalListWidget extends StatelessWidget {
  const HomeJobsProductHorizontalListWidget(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    return SliverToBoxAdapter(
      child: Consumer<JobsProductProvider>(
        builder: (BuildContext context, JobsProductProvider productProvider,
            Widget? child) {
                    ...
                    children: <Widget>[
                      MyHeaderWidget(
                        headerName: Utils.getString(
                            context, 'home__drawer_menu_jobs_item'),
                        headerDescription: '',
                        viewAllClicked: () {
