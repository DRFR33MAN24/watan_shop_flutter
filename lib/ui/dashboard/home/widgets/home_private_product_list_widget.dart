...
class HomePrivateProductListWidget extends StatelessWidget {
  const HomePrivateProductListWidget(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    return SliverToBoxAdapter(
      child: Consumer<PrivateProductProvider>(
        builder: (BuildContext context, PrivateProductProvider productProvider,
            Widget? child) {
                    ...
                    children: <Widget>[
                      MyHeaderWidget(
                        headerName: Utils.getString(
                            context, 'home__drawer_menu_private_item'),
                        headerDescription: '',
                        viewAllClicked: () {
                          ...
                          Navigator.pushNamed(
                              ...
                              arguments: ProductListIntentHolder(
                                  appBarTitle: Utils.getString(context,
                                      'home__drawer_menu_private_item'),
