...
class HomeElectronicProductHorizontalListWidget extends StatelessWidget {
  const HomeElectronicProductHorizontalListWidget(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    return SliverToBoxAdapter(
      child: Consumer<ElectronicProductProvider>(
        builder: (BuildContext context,
            ElectronicProductProvider productProvider, Widget? child) {
                    ...
                    children: <Widget>[
                      MyHeaderWidget(
                        headerName: Utils.getString(
                            context, 'home__drawer_menu_electronic_item'),
                        headerDescription: '',
                        viewAllClicked: () {
                          ...
                          Navigator.pushNamed(
                              ...
                              arguments: ProductListIntentHolder(
                                  appBarTitle: Utils.getString(context,
                                      'home__drawer_menu_electronic_item'),
