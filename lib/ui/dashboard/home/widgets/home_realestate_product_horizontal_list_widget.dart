...
class HomeRealestateProductHorizontalListWidget extends StatelessWidget {
  const HomeRealestateProductHorizontalListWidget(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    return SliverToBoxAdapter(
      child: Consumer<RealestateProductProvider>(
        builder: (BuildContext context,
            RealestateProductProvider productProvider, Widget? child) {
                    ...
                    children: <Widget>[
                      MyHeaderWidget(
                        headerName: Utils.getString(
                            context, 'home__drawer_menu_realestate_item'),
                        headerDescription: '',
                        viewAllClicked: () {
                          ...
                          Navigator.pushNamed(
                              ...
                              arguments: ProductListIntentHolder(
                                  appBarTitle: Utils.getString(context,
                                      'home__drawer_menu_realestate_item'),
