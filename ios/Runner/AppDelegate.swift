...
//     BTAppContextSwitcher.setReturnURLScheme("com.sabeal.watanshop.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.sabeal.watanshop.braintree") == .orderedSame {
